...
showModal('Attention','Product Not found.','nop');
    ...
    showModal('Attention','This Item is out of Stock','nop');
  ...
  showModal('Attention!',`Only ${product.stock} items In Stock`,'nop');
...
showModal('Attention','Cart is Empty','nop');
